	...
	<view>
		<view class="view-header-wrapper">
			<view class="view-header">
				<view class="view-search" @click="uni.navigateTo({url:'../search-details-min/search-details'})">
		...
		<!-- <button @click="uni.navigateTo({url:'../child-details/civilian-school/civilian-school'})">民办详情</button> -->
		
		
		<!-- ../school-details/school-details -->
		<view class="view-list">
			<view class="view-item" v-for="item in list" @click="uni.navigateTo({
				url:'../interest-details/public-details?id='+item.id+'&schoolType='+item.schoolTypeId+'&types='+3
			})">
	...
	export default {
		...
		methods: {
			...
			async getList(){
				...
				let res=await this.http.get("/app/userHomeNavigation/privateSchoolList",{
					pageNum:1,
					pageSize:10,
					type:this.types,
