	...
	<view class="view-container">
		...
		<view class="view-form">
			...
			<view class="view-form-item">
				...
				<view class="view-line"></view>
				<input type="number" maxlength="6" :password="!showPassword" v-model="newPassword" placeholder="6位数字组合" />
			...
			<view class="view-form-item">
				...
				<view class="view-line"></view>
				<input  type="number" maxlength="6" :password="!showPassword1" v-model="confirmPassword" placeholder="6位数字组合" />
	...
	export default {
		...
		methods: {
			...
			async resetPassword() {
				...
				let res = await this.http.post('/app/userInfo/updatespacePassword', {
					code: this.code,
					phone: this.phone,
					spacePassword: this.confirmPassword,
				});
				if (res.code == 200) {
