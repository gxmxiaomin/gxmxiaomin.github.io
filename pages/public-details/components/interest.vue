	...
	<view class="comp-interest">
		...
		<view class="inter-box">
			...
			<view class="honor-list">
				<view class="honor-cell" v-for="(i,index) in achievement" :key="index">
		...
		<!-- 校园环境 -->
		<view class="inter-box">
			<text class="inter-title">校园环境</text>
			<view class="img">
				<img @click="showImg(interInfo.schoolInfo.backgroundImage)" :src="interInfo.schoolInfo.backgroundImage"
					alt="">
			</view>
		...
		<!-- 校园风采 -->
		<view class="inter-box">
			<text class="inter-title">校服展示</text>
			<view class="img">
				<img src="https://img2.baidu.com/it/u=436635185,1433075744&fm=253&fmt=auto&app=138&f=JPEG?w=666&h=500"
					alt=""
					@click="showImg('https://img2.baidu.com/it/u=436635185,1433075744&fm=253&fmt=auto&app=138&f=JPEG?w=666&h=500')">
			</view>
		</view>

		<!-- 片区划分 -->
		<view class="inter-box">
			<text class="inter-title">片区划分</text>
			<view class="img">
				<img :src="interInfo.schoolInfo.schoolInfo.backgroundImage" alt=""
					@click="showImg(interInfo.schoolInfo.schoolInfo.backgroundImage)">
			</view>
		</view>
		...
		<view class="footer">
			...
			<view class="btn" @click="gogogo">
				<u-button text="年级详情" type="primary" shape="circle"></u-button>
			</view>
		</view>
...
<script>
	...
	export default {
		props: ['interInfo', 'sharUrl','schoolName','isShare'],
		data() {
			return {
				//名师展示
				info: [],
		...
		created() {
			setTimeout(() => {
				...
				console.log('****************************', this.info,this.introduce)
		...
		methods: {
			...
			gogogo(){
				DownloadMethods(this.isShare||false,this.gogogos())
			},
