<template>
	<view>
		<view class="box" v-if="this.schoolevaluate != [] || this.schoolevaluate != null">
			<view class="score">
				<view>5.0</view>
				<text>分</text>
				<view class="count">2668条评论</view>
				<view class="fen">
					<image src="@/static/images/shoucang.svg" mode=""></image>
					<image src="@/static/images/shoucang.svg" mode=""></image>
					<image src="@/static/images/shoucang.svg" mode=""></image>
					<image src="@/static/images/shoucang.svg" mode=""></image>
					<image src="@/static/images/shoucang.svg" mode=""></image>
			...
			<view class="box-1" v-for="item in schoolevaluate">
				...
				<view class="box-3">
					...
					<view class=""><text>回复(0)</text></view>
				</view>
			</view>
			
		</view>
		
		<view v-else class="noevaluate">
			还没有评价
		</view>
	</view>
</template>
...
<script>
	export default {
		...
		created(){
			setTimeout(()=>{
				console.log('evaluate接收到的参数',this.schoolevaluate)
			},500)
		},
