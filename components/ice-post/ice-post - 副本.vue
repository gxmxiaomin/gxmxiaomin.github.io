			...
			<view class="view-bottom">
				...
				<view class="view-right">
					<view @click.stop="dianzan(item.id)">
						<image :src="item.voteStatus?'../../static/images/xihuan.png':'../../static/images/like.png'"
							mode=""></image>
		...
		methods: {
			getVideoCover(videoCover) {
				if (videoCover.videoCover != "" && videoCover.videoCover != null) {
					...
					this.image1 = videoCover.content[0].image;
					this.image2 = videoCover.content[1].image;
					this.image3 = videoCover.content[2].image;
				}
			},
			confirm(e) {
				console.log(e);
